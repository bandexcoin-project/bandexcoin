...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " bandexcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  bandexcoin-tx [options] <hex-tx> [commands]  Update hex-encoded bandexcoin transaction\n" +
            "or:     bandexcoin-tx [options] -create [commands]   Create hex-encoded bandexcoin transaction\n" +
            "\n";
