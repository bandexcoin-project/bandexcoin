# Support for Output Descriptors in Bandexcoin Core

Since Bandexcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Bandexcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Bandexcoin Core wallets, a convenience function `combo` is
