...
"""Verify that starting bandexcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bandexcoin with -h for help text")
        ...
        self.log.info("Start bandexcoin with -version for version information")
        ...
        self.log.info("Start bandexcoind with -fakearg to make sure it does not start")
